...
parser.add_argument('--epoch', default=1, type=int, help='Number of epochs for shadow and target model.')
...
def main():
    ...
    target_net = shadow_net = StudentNet()
    ...
    shadow_optim = optim.Adam(shadow_net.parameters(), lr=0.01)
